...
public class Main {
    ...
    /**
     * Creates a word suggester, loads {@code messages.txt} into it,
     * and then enters a loop so the user can test out word suggestions.
     * The program exits when the user enters a blank line.
     *
